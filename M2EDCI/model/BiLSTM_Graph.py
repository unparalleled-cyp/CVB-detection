...
class BiLSTM_Graph(nn.Module):
    """
    Construction method: process one graph at a time
    1. The inputs are first processed through BiLSTM to obtain the encoded vectors lstm_outputs
    2. The lstm_outputs and adj are then passed to the GAT. Note that the 0th dimension of both lstm_outputs and adj must be 1
    """
    def __init__(self,
                 char_emb_dim,
                 lstm_hidden_dim,
