...
class SparseEmbedding(nn.Module):
    ...
    Encode discrete categories:
        1、gender  unknown, male, female
        2、focus_num\fans_num\blogs_num  first divide them into ranges, such as 0-10, 10-50, etc.
        3、verify  Weibo personal verification, Weibo official verification, others are considered unverified
        4、vip  0~7
        5、education: no education info, unmatched education, real education level
        6、place  others, specific provinces
    """
...
class UserInfoEmbedding(nn.Module):
    def __init__(self,
        ...
        :param sparse_num_dict: 为字典格式
                1、gender  
                2、focus_num\fans_num\blogs_num  
                3、verify  
                4、vip  0~7
                5、edu 
                6、place  
