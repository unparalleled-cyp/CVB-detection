...
net_arg.add_argument('--lstm_hidden_dim', type=int, default=256)  
...
net_arg.add_argument('--gat_hidden_dim', type=int, default=256)  
net_arg.add_argument('--alpha', type=float, default=0.1)  # 用于GAT中的leaky relu
...
data_arg.add_argument("--char_alphabet_size", type=int, default=5789)  # 字符词典个数 5563
data_arg.add_argument("--label_size", type=int, default=3)  # 标签数
# data_arg.add_argument("--param_stored_fileholder", type=str, default=r"saved_model")
...
learn_arg.add_argument('--batch_size', type=int, default=150)# 150
learn_arg.add_argument('--max_epoch', type=int, default=10) # 50
learn_arg.add_argument('--lr', type=float, default=0.0001) # 0.001
learn_arg.add_argument('--lr_decay', type=float, default=0.001)
...
misc_arg.add_argument('--mode', type=str, default="train", choices=["train", "val", "predict"]) # train
misc_arg.add_argument('--shuffle', type=bool, default=True)
misc_arg.add_argument('--use_gpu', type=bool, default=True)
misc_arg.add_argument('--use_weights', type=bool, default=True)  # 在求loss的时候，针对数据不均衡做调整
misc_arg.add_argument('--visible_gpu', type=str, default="0")
misc_arg.add_argument('--random_seed', type=int, default=1)
misc_arg.add_argument('--print_iter', type=int, default=20)  # 20  # 1
misc_arg.add_argument('--evaluate_train', type=int, default=5)  # 每5 epoch 验证一次训练集, 每个 epoch 验证均验证测试集
